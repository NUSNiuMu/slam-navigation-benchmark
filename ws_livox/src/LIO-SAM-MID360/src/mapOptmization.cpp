...
public:
    ...
    bool saveMapService(lio_sam::save_mapRequest& req, lio_sam::save_mapResponse& res)
    {
      ...
      // Guard: avoid crashing when map has no keyframes/points yet.
      if (cloudKeyPoses3D->empty() || cloudKeyPoses6D->empty())
      {
        cout << "Skip saving map: no key poses available yet." << endl;
        res.success = false;
        return true;
      }
      ...
      *globalMapCloud += *globalSurfCloud;
      ...
      {
        cout << "Skip saving GlobalMap.pcd: no points in global map." << endl;
        res.success = false;
        return true;
      }
    ...
    void scan2MapOptimization()
    {
        ...
        PROFILE_SCOPE("scan2MapOptimization");
